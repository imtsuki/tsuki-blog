    ...
    variants: {
      type: {
        ...
        warning: [
          ...
          'dark:text-amber-50',
          "*:first:before:content-['Warning:_']",
        ],
        danger: [
          'border-red-600',
          'bg-red-100/50',
